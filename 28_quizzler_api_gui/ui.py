...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_btn = Button(image=true_img, highlightthickness=0, command=self.on_true_click, bd=0)
        self.true_btn.grid(row=2, column=0)

        false_img = PhotoImage(file="images/false.png")
        self.false_btn = Button(image=false_img, highlightthickness=0, command=self.on_false_click, bd=0)
